...
<body class="fundo">
    ...
    <div class="container">
        <div class="lista">
            ...
            <div class="pesquisa">
                <form action="pesquisaCPF.php" method="post">
                    <div class="mb-3">
                        <input type="number" class="form-control" id="inputPassword2" placeholder="Pequisar por CPF">
                    </div>
                    <div class="mb-3">
            ...
            <a href="listaEleitores.php" class="btn btn-warning">Voltar</a>
        </div>
    </div>
</body>
</html>